...
export default function Home() {
  ...
  return (
    <div>
      <div>
        <p className="flex p-5">joseph (joe) dubravec</p>
        <p className="flex px-5 pb-5">computer scientist, composer, musican, poet, camper</p>
        <Menu />
      </div>
      <div className="flex">
          <a href="https://github.com/joedubravec">
            <Image
              src="/nextjs-github-pages/github-mark.svg"
              alt="Github Logo"
          ...
          <a href="https://www.linkedin.com/in/josephdubravec/">
            <Image
              src="/nextjs-github-pages/LI-in-Bug.png"
              alt="Linkedin Logo"
              className="flex:1 p-2 width:auto height:auto"
              width={635 / 10}
              height={540 / 10}
